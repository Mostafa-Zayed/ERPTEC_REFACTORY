LANG = {
    'required': 'إلزامي',
    'required_shipment': 'اختار شركه الشحن',
    'sure': 'هل أنت متأكد ؟',
    ...
    'tour_step2_title': 'الخطوة 0: ابدأ مع النظام',
    'tour_step2_content':'شرح تفصيلى للنظام',
    'tour_step3_title': 'الخطوة 1: تفاصيل المتجر',
    'tour_step3_content':'هنا يمكنك العثور على معلومات متعلقة بمتجرك ، ومعلومات أساسية ، و SKU المنتج ، والخصومات ، والضرائب والإعدادات الأخرى.',
    'tour_step4_title': 'الخطوة 2: إضافة الموارد',
    'tour_step4_content': 'أضف العلامات التجارية ، ومعدلات الضرائب ، والوحدات ، والأصناف الخاصة بمتجرك.',
    'tour_step5_title': 'الخطوة 3: الموردين و الزبائن(العملاء)',
    'tour_step5_content': 'جميع الموردين والزبائن لمتجرك.',
    'tour_step6_title': 'الخطوة 4: إدارة المنتجات',
    'tour_step6_content': 'إضافة منتجات - منتجات بسيطة أو متباينة ، قم بإنشاء نماذج للمنتجات المتباينة ، وتسميات الطباعة.',
    'tour_step7_title': 'الخطوة 5: إدارة المشتريات',
    'tour_step7_content': 'إدارة المشتريات والدفع لعمليات الشراء.',
    'tour_step8_title': 'الخطوة 6: إدارة المبيعات',
    'tour_step8_content': 'بيع -> نقطة البيع ، استخدم هذه الشاشة أثناء بيع المنتجات أو فواتير العملاء. حدد الموقع ، إضافة المنتجات وإنهاء البيع.',
    'tour_step9_title': 'الخطوة 7: التقارير',
    'tour_step9_content':'عرض التقارير التحليلية لمتجرك. تساعدك هذه التقارير في الحصول على معلومات عامة حول أداء نشاطك التجاري.',
    ...
    "remove_customer_groups": "اخفاء مجموعات العملاء",
    "add_customer_groups_to_user": "اضف مجموعات عملاء الي المستخدم",
    "remove_your_location": "Remove Your Location ",
