    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('product_tax_type', ['inc' => __('woocommerce::lang.inc_tax'), 'exc' => __('woocommerce::lang.exc_tax') ], $default_settings['product_tax_type'], ['class' => 'form-select']); !!}
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="form-group">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="form-group">
                ...
                {!! Form::select('sync_description_as', ['short' => __('woocommerce::lang.short_description'), 'long' => __('woocommerce::lang.long_description'), 'both' => __('woocommerce::lang.both')], !empty($default_settings['sync_description_as']) ? $default_settings['sync_description_as'] : 'long', ['class' => 'form-select select2', 'style' => 'width: 100%;']); !!}
            </div>
        </div>
        <div class="col-xs-12">
            <hr>
        ...
        <div class="col-lg-4 col-md-6 @if(in_array('quantity', $default_settings['product_fields_for_create'])) hide @endif create_stock_settings">
            <div class="form-group">
                {!! Form::label('manage_stock_for_create',  __('product.manage_stock') . ':') !!}
                {!! Form::select('manage_stock_for_create', ['true' => 'true', 'false' => 'false', 'none' => __('woocommerce::lang.dont_update') ], isset($default_settings['manage_stock_for_create']) ? $default_settings['manage_stock_for_create'] : 'none', ['class' => 'form-select']); !!}
            </div>
        </div>
        <div class="col-lg-4 col-md-6 @if(in_array('quantity', $default_settings['product_fields_for_create'])) hide @endif create_stock_settings">
            <div class="form-group">
                {!! Form::label('in_stock_for_create',  __('woocommerce::lang.in_stock') . ':') !!}
                {!! Form::select('in_stock_for_create', ['true' => 'true', 'false' => 'false', 'none' => __('woocommerce::lang.dont_update') ], isset($default_settings['in_stock_for_create']) ? $default_settings['in_stock_for_create'] : 'none', ['class' => 'form-select']); !!}
            </div>
        </div>
        <div class="col-xs-12">
            <hr>
        ...
        <div class="col-lg-4 col-md-6 @if(in_array('quantity', $default_settings['product_fields_for_update'])) hide @endif update_stock_settings">
            <div class="form-group">
                ...
                {!! Form::select('manage_stock_for_update', ['true' => 'true', 'false' => 'false', 'none' => __('woocommerce::lang.dont_update') ], isset($default_settings['manage_stock_for_update']) ? $default_settings['manage_stock_for_update'] : 'none', ['class' => 'form-select']); !!}
            </div>
        </div>
        <div class="col-lg-4 col-md-6 @if(in_array('quantity', $default_settings['product_fields_for_update'])) hide @endif update_stock_settings">
            <div class="form-group">
                {!! Form::label('in_stock_for_update',  __('woocommerce::lang.in_stock') . ':') !!}
                {!! Form::select('in_stock_for_update', ['true' => 'true', 'false' => 'false', 'none' => __('woocommerce::lang.dont_update') ], isset($default_settings['in_stock_for_update']) ? $default_settings['in_stock_for_update'] : 'none', ['class' => 'form-select']); !!}
            </div>
        </div>
    </div>
</div>