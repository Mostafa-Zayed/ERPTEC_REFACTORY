...
class CmsController extends Controller
{
    ...
    public function index($lang = null)
    {
        ...
        $features   = CmsSiteDetail::getValue('features',false);
        
        $sliders    = CmsSiteDetail::getValue('sliders',false);
        
        // dd($testimonials,$page,$faqs,$statistics,$features,$sliders);
        return view('cms::frontend.pages.home')->with(compact('testimonials', 'faqs', 'statistics', 'page','features','sliders'));
    }
