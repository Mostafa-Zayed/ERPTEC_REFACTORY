...
use App\Http\Requests\Warranties\StoreWarranty;
...
class WarrantyController extends Controller
{
    ...
    private $warrantyInterface;
    
    public function __construct(WarrantyInterface $warrantyInterface)
    {
    ...
    {
        try {
            if(BusinessService::businessCan([])){
                if($data = $this->warrantyInterface->add($request->validated())){
                    return [      
                        'success' => true,
                        'data' => $data,
