    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="form-group">
                ...
                <p style="overflow-wrap: break-word;">{{action('\Modules\Woocommerce\Http\Controllers\WoocommerceWebhookController@orderCreated', ['business_id' => session()->get('business.id')])}}</p>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="form-group">
                <strong>@lang('woocommerce::lang.webhook_delivery_url'):</strong>
                <p style="overflow-wrap: break-word;">{{action('\Modules\Woocommerce\Http\Controllers\WoocommerceWebhookController@orderUpdated', ['business_id' => session()->get('business.id')])}}</p>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="form-group">
                <strong>@lang('woocommerce::lang.webhook_delivery_url'):</strong>
                <p style="overflow-wrap: break-word;">{{action('\Modules\Woocommerce\Http\Controllers\WoocommerceWebhookController@orderDeleted', ['business_id' => session()->get('business.id')])}}</p>
            </div>
        </div>
        ...
        <div class="col-lg-8">
            <div class="form-group">
                <strong>@lang('woocommerce::lang.webhook_delivery_url'):</strong>
                <p style="overflow-wrap: break-word;">{{action('\Modules\Woocommerce\Http\Controllers\WoocommerceWebhookController@orderRestored', ['business_id' => session()->get('business.id')])}}</p>
            </div>
        </div>
