...
Route::group(['middleware' => ['web', 'auth', 'language', 'AdminSidebarMenu'], 'prefix' => 'superadmin', 'namespace' => 'Modules\Superadmin\Http\Controllers'], function () {
    ...
    /* shipment */
    Route::get('/shipment','SuperadminController@shipment')->name('superadmin.shipment');
    Route::get('/shipment/country','CountryController@index')->name('superadmin.shipment.country');
    /* packages new */
    Route::get('/packages2','PackageController2@index');
