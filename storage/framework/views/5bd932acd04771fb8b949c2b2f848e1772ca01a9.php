...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('website/images/logo_test.png'), false); ?>">
    <title><?php echo $__env->yieldContent('title'); ?> - <?php echo e(config('app.name', 'ERP TEC'), false); ?></title> 
    <link rel="stylesheet" href="<?php echo e(asset('front/vendor/bootstrap/css/bootstrap.min.css'), false); ?> ">
                    ...
                    <select class="form-control input-sm" id="change_lang" style="margin: 10px;">
                        <?php if(! empty($languages)): ?> 
                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key, false); ?>" <?php if( (empty(request()->lang) && config('app.locale') == $key) || request()->lang == $key): ?> selected <?php endif; ?> > <?php echo e($val['full_name'], false); ?> </option>
                ...
                <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                    <?php if(!($request->segment(1) == 'business' && $request->segment(2) == 'register')): ?>
                        ...
                        <?php if(config('constants.allow_registration')): ?>
                            <a href="<?php echo e(route('register'), false); ?><?php if(!empty(request()->lang)): ?><?php echo e('?lang=' . request()->lang, false); ?> <?php endif; ?>" class="btn bg-maroon btn-flat" style="margin: 0 10px;"><b><?php echo e(__('business.not_yet_registered'), false); ?></b> <?php echo e(__('business.register_now'), false); ?></a>
                            <!-- pricing url -->
...
</html><?php /**PATH F:\ERPTEC_REFACTORY_5.8\resources\views/layouts/auth2.blade.php ENDPATH**/ ?>