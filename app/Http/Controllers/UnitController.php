...
class UnitController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Util $commonUtil,UnitInterface $unitInterface)
    {
    ...
    {
        if($this->businessCan(['unit.view','unit.create'])){
            if (request()->ajax()) {
                $units = $this->unitInterface->getAll(BusinessService::getBusinessId());
