...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'shopify';
        $this->appVersion = config('shopify.module_version');
    }
    ...
    public function index()
    {
        ...
        if (empty($is_installed)) {
            ...
            Artisan::call('module:migrate', ['module' => "Shopify"]);
            System::addProperty($this->module_name . '_version', $this->appVersion);
        }

        $output = ['success' => 1,
                    'msg' => 'Shopify module installed succesfully'
                ];
        return redirect()
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1,
                        'msg' => 'Shopify module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
            return redirect()
                ->action('HomeController@index')
                ->with('status', $output);
