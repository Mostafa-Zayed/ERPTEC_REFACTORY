    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="mb-5">
                    {!! Form::label('name', __('product.product_name_en') . ':*') !!}
                    {!! Form::text('name', !empty($duplicate_product->name) ? $duplicate_product->name : null, ['class' => 'form-control', 'required','placeholder' => __('product.product_name_en')]); !!}
                </div>
            </div>
            
            <div class="col-sm-4">
                <div class="form-group">
                    {!! Form::label('name_ar', __('product.product_name') . ':*') !!}
                    {!! Form::text('name_ar', !empty($duplicate_product->name) ? $duplicate_product->name : null, ['class' => 'form-control', 'required',
