<div class="col-md-3">
	<div class="form-group">
      ...
      <br>
        <label>
        	<input type="hidden" name="shopify_disable_sync" value="0">
          	{!! Form::checkbox('woocommerce_disable_sync', 1, $is_disabled, ['class' => 'input-icheck']); !!} <strong>@lang('shopify::lang.shopify_disable_sync')</strong>
        </label>
