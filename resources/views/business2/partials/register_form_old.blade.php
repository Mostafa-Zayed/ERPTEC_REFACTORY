...
<fieldset>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('email', __('business.email_confirm') . ':') !!}
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                {!! Form::text('confirm_email', null, ['class' => 'form-control','id' => 'email_confirm','placeholder' => __('business.email_confirm'),'required']); !!}
            </div>
        </div>
    </div>
