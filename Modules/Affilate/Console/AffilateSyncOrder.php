...
use Modules\Affilate\Notifications\SyncOrdersNotification;

use DB;

class AffilateSyncOrder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'pos:AffilateSyncOrder {business_id}';
     ...
     * @var string
     */
    protected $description = 'Syncs all orders from Affilate App to POS';
    ...
    public function handle()
    {
        try {
            ...
            $this->affilateUtil->syncOrders($business_id, $owner_id);
