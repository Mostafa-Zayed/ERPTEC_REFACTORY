        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="flex-direction:row;">
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'business') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\BusinessController@index')}}">@lang('superadmin::lang.all_business')</a>
                    </li>
                    ...
                    <li @if(request()->segment(1) == 'superadmin' && request()->segment(2) == 'communicator') class="active" @endif><a href="{{action('\Modules\Superadmin\Http\Controllers\CommunicatorController@index')}}">@lang('superadmin::lang.communicator')</a>
                    </li>
                    
                    <li @if( request()->segment(1) == 'superadmin' && request()->segment(2) == 'shipment') class="active" @endif> 
                        <a href="{{route('superadmin.shipment')}}">@lang('superadmin::lang.shipment')</a>
                    </li>
