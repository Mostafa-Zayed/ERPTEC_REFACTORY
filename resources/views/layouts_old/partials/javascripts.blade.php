...
<![endif]-->
{{-- <script src="{{ asset('public/js/vendor2.js?v=' . $asset_v) }}"></script> --}}

<script src="{{ asset('public/js/vendor.js?v=' . $asset_v) }}"></script> 
@if(file_exists(public_path('public/js/lang/' . session()->get('user.language', config('app.locale')) . '.js')))
...
<script>
    ...
    @if(file_exists(public_path('public/AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js')))
...
<script src="{{ asset('public/js/documents_and_note.js?v=' . $asset_v) }}"></script>
...
@endphp
@if(file_exists(public_path() . 'public/js/jquery-validation-1.16.0/src/localization/' . $validation_lang_file))
