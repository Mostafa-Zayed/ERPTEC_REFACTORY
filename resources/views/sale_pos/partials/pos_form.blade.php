...
<div class="row">
        ...
        <div class="col-md-3 col-sm-6">
			<div class="form-group">
			    <div class="input-group">
				    ...
				    {!! Form::select('address_id',[__('lang_v1.select_address')],null, ['class' => 'form-control form-select select2 mousetrap','id' => 'address_id']); !!}
				</div>
				
			</div>
        </div>
        <div class="col-md-9" id="address_info">
    ...
    <!-- Shipment Module-->
        <div class="col-md-3 col-sm-6">
            <div class="form-group">
				<div class="input-group">
				    {!! Form::label('shipment_company_id', __('shipment::lang.company') . ':') !!}
				    {!! Form::select('shipment_company_id',$shipmentCompanies,null, ['class' => 'form-control form-select select2 mousetrap','id' => 'shipment_company_id']); !!}
				</div>
			</div>
        </div> 
        <div class="col-md-3 col-sm-6" id="voo_area" style="display:none;"></div>
        <div class="col-md-3 col-sm-6" id="voo_courier" style="display:none;"></div>
        <div class="col-md-3 col-sm-6">
            <div class="form-group">
				<div class="input-group">
				    {!! Form::label('shipment_account_id', __('shipment::lang.account') . ':') !!}
				    {!! Form::select('shipment_account_id',[],null, ['class' => 'form-control form-select select2 mousetrap', 'id'=> 'shipment_account_id']); !!}
				</div>
			</div>
        </div>
        <div class="col-md-3 col-sm-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control " name="shipping_charges_show" id="shipping_charges_show" value="0" data-default="0.00" disabled>
            </div>    
        </div>
