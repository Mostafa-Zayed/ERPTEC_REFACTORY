            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="flex-direction: row;">
                    ...
                    <?php if(auth()->user()->can('essentials.access_sales_target')): ?>
                        <li <?php if(request()->segment(1) == 'hrm' && request()->segment(2) == 'sales-target'): ?> class="active" <?php endif; ?>><a href="<?php echo e(action('\Modules\Essentials\Http\Controllers\SalesTargetController@index'), false); ?>"><?php echo app('translator')->getFromJson('essentials::lang.sales_target'); ?></a></li>
                    <?php endif; ?>
...
</section><?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/Modules/Essentials/Providers/../Resources/views/layouts/nav_hrm.blade.php ENDPATH**/ ?>