...
return [
    ...
    */
    ...
    "daily_pickup" => " Maximum number of pickup leads Daily in module CRM            ",


    'transaction_edit_days' => 'You can control the possibility of editing the sales through the number of days that you specify here.',
