...
<?php $__env->startSection('title', __('cms::lang.home')); ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 start-home-img">
                        <img class="img-fluid" src="<?php echo e(asset('public/website/images/banner-2.png'), false); ?>" alt="banner"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="shape-bottom">
            <img src="<?php echo e(asset('public/website/images/shapes/shape-1.svg'), false); ?>" alt="shape" class="bottom-shape img-fluid">
        </div>
    </section>
    <!-- End Home Area -->
    ...
    <section id="how-it-work" class="section-block" data-scroll-index="2">
            <div class="container">
                <div class="section-header">
                    <h2><?php echo app('translator')->getFromJson('cms::lang.how_it_work_headline'); ?></h2>
                    <p style="letter-spacing: 1.5px;"><?php echo app('translator')->getFromJson('cms::lang.how_it_work_description'); ?></p>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-box">
                            <img src="<?php echo e(asset('public/website/images/how-work.png'), false); ?>" alt="Img" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <!-- Start Block 1 -->
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="<?php echo e(asset('public/website/images/step1.png'), false); ?>" /></div>
                                <h3><?php echo app('translator')->getFromJson('cms::lang.how_work_step1_title'); ?></h3>
                                <p style="letter-spacing: 1px;"><?php echo app('translator')->getFromJson('cms::lang.how_work_step1_content'); ?><a href="<?php echo e(route('register') . '?lang=' . app()->getLocale(), false); ?>"><?php echo app('translator')->getFromJson('cms::lang.new_account'); ?></a></p>
                            </div>
                        </div>
                        <!-- End Block 1 -->
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="<?php echo e(asset('public/website/images/step2.png'), false); ?>" /></div>
                                <h3><?php echo app('translator')->getFromJson('cms::lang.how_work_step2_title'); ?></h3>
                                <p style="letter-spacing: 1px;"><?php echo app('translator')->getFromJson('cms::lang.how_work_step2_content'); ?></p>
                            </div>
                        </div>
                        <!-- End Block 2 -->
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="<?php echo e(asset('public/website/images/step3.png'), false); ?>" /></div>
                                <h3><?php echo app('translator')->getFromJson('cms::lang.how_work_step3_title'); ?></h3>
                                <p style="letter-spacing: 1px;"><?php echo app('translator')->getFromJson('cms::lang.how_work_step3_content'); ?></p>
                            </div>
                        </div>
                        <!-- End Block 3 -->
                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="pricing-card">
                                            <header class="card-header">
                                                ...
                                                <div class="shape-bottom">
                                                    <img src="<?php echo e(asset('public/website/images/shapes/price-shape.svg'), false); ?>" alt="shape" class="bottom-shape img-fluid">
                                                </div>
                                            </header>
                                            <div class="card-body">
                                                <ul>
    ...
    <section id="faqs" class="section-block" data-scroll-index="6">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-box">
                            <img src="<?php echo e(asset('public/website/images/faq2.png'), false); ?>" class="img-fluid" alt="Img" />
                        </div>
                    </div>
                    <div class="col-md-6">
    ...
    <section id="contact" class="section-block" data-scroll-index="8">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="section-header-style2">
                            <h2><?php echo app('translator')->getFromJson('cms::lang.contact_us'); ?></h2>
                            <p style="letter-spacing: 1px;">
                                <?php echo app('translator')->getFromJson('cms::lang.contact_title'); ?>
                            </p>
                        </div>
                    ...
                    <div class="col-md-7">
                        <div class="contact-shape">
                            <img src="<?php echo e(asset('public/website/images/shapes/contact-form.png'), false); ?>" class="img-fluid" alt="Img"/>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('cms::frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/Modules/Cms/Providers/../Resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>