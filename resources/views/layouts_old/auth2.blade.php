...
<head>
    ...
    <title>@yield('title') - {{ config('app.name', 'Smsa Erp') }}</title> 
        ...
        <div class="row eq-height-row">
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col" >
                <div class="left-col-content login-header"> 
                    ...
                    @if(file_exists(public_path('public/uploads/logo.png')))
                        <img src="public/uploads/logo.png" class="img-rounded" alt="Logo" width="150">
                    @else
