...
<![endif]-->
<script src="<?php echo e(asset('public/js/vendor.js?v=' . $asset_v), false); ?>"></script>

<?php if(file_exists(public_path('public/js/lang/' . session()->get('user.language', config('app.locale')) . '.js'))): ?>
    <script src="<?php echo e(asset('public/js/lang/' . session()->get('user.language', config('app.locale') ) . '.js?v=' . $asset_v), false); ?>"></script>
<?php else: ?>
    <script src="<?php echo e(asset('public/js/lang/en.js?v=' . $asset_v), false); ?>"></script>
<?php endif; ?>
<?php
...
<script>
    ...
    <?php if(file_exists(public_path('public/AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js'))): ?>
...
<script src="<?php echo e(asset('public/js/functions.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('public/js/common.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('public/js/app.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('public/js/help-tour.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('public/js/documents_and_note.js?v=' . $asset_v), false); ?>"></script>
<script src="<?php echo e(asset('public/front/vendor/owl.carousel/owl.carousel.min.js'), false); ?>"></script>

<!-- TODO -->
<?php if(file_exists(public_path('public/AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale')) . '.js'))): ?>
    <script src="<?php echo e(asset('public/AdminLTE/plugins/select2/lang/' . session()->get('user.language', config('app.locale') ) . '.js?v=' . $asset_v), false); ?>"></script>
<?php endif; ?>
<?php
    $validation_lang_file = 'messages_' . session()->get('user.language', config('app.locale') ) . '.js';
?>

<?php if(file_exists(public_path() . '/public/js/jquery-validation-1.16.0/src/localization/' . $validation_lang_file)): ?>
    <script src="<?php echo e(asset('public/js/jquery-validation-1.16.0/src/localization/' . $validation_lang_file . '?v=' . $asset_v), false); ?>"></script>
<?php endif; ?>
...
<!--<script src="<?php echo e(asset('public/new_assets/js/main.js'), false); ?> "></script>-->
<script>
...
<?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/resources/views/layouts/partials/javascripts.blade.php ENDPATH**/ ?>