            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 start-home-img">
                        <img class="img-fluid" src="<?php echo e(asset('website/images/banner-2.png'), false); ?>" alt="banner"/>
                    </div>
                </div>
            </div>
        </div>
        <div class="shape-bottom">
            <img src="<?php echo e(asset('website/images/shapes/shape-1.svg'), false); ?>" alt="shape" class="bottom-shape img-fluid">
        </div>
    </section>
    <!-- End Home Area -->
    ...
    <section id="how-it-work" class="section-block" data-scroll-index="2">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-box">
                            <img src="<?php echo e(asset('website/images/how-work.png'), false); ?>" alt="Img" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <!-- Start Block 1 -->
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="<?php echo e(asset('website/images/step1.png'), false); ?>" /></div>
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="<?php echo e(asset('website/images/step2.png'), false); ?>" /></div>
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="<?php echo e(asset('website/images/step3.png'), false); ?>" /></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="pricing-card">
                                            <header class="card-header">
                                                ...
                                                <div class="shape-bottom">
                                                    <img src="<?php echo e(asset('website/images/shapes/price-shape.svg'), false); ?>" alt="shape" class="bottom-shape img-fluid">
                                                </div>
                                            </header>
                                            <div class="card-body">
                                                <ul>
    ...
    <section id="faqs" class="section-block" data-scroll-index="6">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="img-box">
                            <img src="<?php echo e(asset('website/images/faq2.png'), false); ?>" class="img-fluid" alt="Img" />
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="contact-shape">
                            <img src="<?php echo e(asset('website/images/shapes/contact-form.png'), false); ?>" class="img-fluid" alt="Img"/>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('cms::frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\ERPTEC_REFACTORY_5.8\Modules\Cms\Providers/../Resources/views/frontend/pages/home.blade.php ENDPATH**/ ?>