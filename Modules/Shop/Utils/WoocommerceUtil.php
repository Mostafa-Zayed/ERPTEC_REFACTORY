...
class WoocommerceUtil extends Util
{
    ...
    public function formatOrderToSale($business_id, $user_id, $order, $sell = null)
    {
        ...
        if (empty($order_customer_id) && empty($customer_details['email'])) {
         ...
         //   $customer = $contactUtil->getWalkInCustomer($business_id, false);
                ...
                if($customer_details['state'] == 'EGALX'){
                    
                    $customer_details['state'] = 'alexandria';
                    
                }elseif($customer_details['state'] == 'EGASN'){
                    
                    $customer_details['state'] = 'aswan';
                    
                }elseif($customer_details['state'] == 'EGAST'){
                    
                    $customer_details['state'] = 'Asyut';
                    
                }elseif($customer_details['state'] == 'EGBA'){
                    
                    $customer_details['state'] = 'Redsea';
                    
                }elseif($customer_details['state'] == 'EGBH'){
                    
                    $customer_details['state'] = 'Albuhayra';
                    
                }elseif($customer_details['state'] == 'EGBNS'){
                    
                    $customer_details['state'] = 'Bani Sweif';
                    
                }elseif($customer_details['state'] == 'EGC'){
                    
                    $customer_details['state'] = 'Cairo';
                    
                }elseif($customer_details['state'] == 'EGDK'){
                    
                    $customer_details['state'] = 'Dakahlia';
                    
                }elseif($customer_details['state'] == 'EGDT'){
                    
                    $customer_details['state'] = 'Damiat';
                    
                }elseif($customer_details['state'] == 'EGFYM'){
                    
                    $customer_details['state'] = 'Fayoum';
                    
                }elseif($customer_details['state'] == 'EGGH'){
                    
                    $customer_details['state'] = 'Al gharbia';
                    
                }elseif($customer_details['state'] == 'EGGZ'){
                    
                    $customer_details['state'] = 'Giza';
                    
                }elseif($customer_details['state'] == 'EGIS'){
                    
                    $customer_details['state'] = 'Ismailia';
                    
                }elseif($customer_details['state'] == 'EGJS'){
                    
                    $customer_details['state'] = 'south sinai';
                    
                }elseif($customer_details['state'] == 'EGKB'){
                    
                    $customer_details['state'] = 'Qalyubia';
                    
                }elseif($customer_details['state'] == 'EGKFS'){
                    
                    $customer_details['state'] = 'Kafr El Sheikh';
                    
                }elseif($customer_details['state'] == 'EGKN'){
                    
                    $customer_details['state'] = 'Qena';
                    
                }elseif($customer_details['state'] == 'EGLX'){
                    
                    $customer_details['state'] = 'Luxor';
                    
                }elseif($customer_details['state'] == 'EGMN'){
                    
                    $customer_details['state'] = 'Minya';
                    
                }elseif($customer_details['state'] == 'EGMNF'){
                    
                    $customer_details['state'] = 'Al Monufia';
                    
                }elseif($customer_details['state'] == 'EGMT'){
                    
                    $customer_details['state'] = 'Marsa Matrouh';
                    
                }elseif($customer_details['state'] == 'EGPTS'){
                    
                    $customer_details['state'] = 'Puerto Said';
                    
                }elseif($customer_details['state'] == 'EGSHG'){
                    
                    $customer_details['state'] = 'Souhag';
                    
                }elseif($customer_details['state'] == 'EGSHR'){
                    
                    $customer_details['state'] = 'Alsharqia';
                    
                }elseif($customer_details['state'] == 'EGSIN'){
                    
                    $customer_details['state'] = 'North Sinai';
                    
                }elseif($customer_details['state'] == 'EGSUZ'){
                    
                    $customer_details['state'] = 'Suez';
                    
                }elseif($customer_details['state'] == 'EGWAD'){
                    
                    $customer_details['state'] = 'Alwadi Aljadid';
  ...
  // \Log::info(json_encode($customer));
    ...
    public function woocommerceOrderStatusToPosSellStatus($status, $business_id)
    {
        ...
        $sale_status = !empty($status_settings) ? !empty($status_settings->$status) ? $status_settings->$status : null : null;
