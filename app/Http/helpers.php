...
if(! function_exists('get_direction_value')) {
    function get_direction_value()
    {
        return in_array(session()->get('user.language', config('app.locale')), config('constants.langs_rtl')) ? 'rtl' : 'ltr';    
    }
}

if(! function_exists('get_business_theme_color')) {
    function get_business_theme_color()
    {
        return ! empty(session('business.theme_color')) ? session('business.theme_color') : 'blue-light' ;
    }
}

if(! function_exists('is_business_announce')) {
    function is_business_announce()
    {
        return ! empty(auth()->user()->business_id) ? App\Business::where('id',auth()->user()->business_id)->first()->announce : false;
    }
}
...
if(! function_exists('get_business')) {
    ...
    {
        return auth()->user()->business_id ? App\Business::where('id',auth()->user()->business_id)->first() : null;
    }
}
