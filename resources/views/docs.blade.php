...
<style>/*.search:before{content:"\f002"}*/
    ...
    <script src="{{asset('public/js/docs.js')}}" type="35baa7ef7b36925f865633bf-text/javascript">
  ...
  <body class="">
    ...
    <div class="tocify-wrapper">
        <img src="{{asset('public/uploads/cms/logo.png')}}" style="width: 96%;" />
...
<code>
    ...
    $response = $http->post('https://erptec.net/erp/api/oauth/token', <br>
                    [<br>
                        'form_params' => [<br>
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/brand"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/brand/1"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/business-location"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/business-location/1"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/contactapi?type=natus" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/contactapi"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/contactapi/1"
);
...
<pre><code class="language-bash">curl -X POST \
    "https://erptec.net/erp/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/product?brand_id=alias&amp;category_id=alias&amp;sub_category_id=nobis&amp;location_id=ut&amp;selling_price_group=accusamus&amp;name=nisi&amp;sku=ipsa&amp;per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/product"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/product/1?selling_price_group=est" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/product/1"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/selling-price-group"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/variation/?brand_id=beatae&amp;category_id=porro&amp;sub_category_id=non&amp;not_for_selling=magni&amp;name=rerum&amp;sku=enim&amp;per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/variation/"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/sell?location_id=deserunt&amp;contact_id=ex&amp;payment_status=paid&amp;start_date=2018-06-25&amp;end_date=2018-06-25&amp;user_id=voluptatem&amp;service_staff_id=dolores&amp;shipping_status=ordered&amp;only_subscriptions=unde&amp;per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/sell"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/sell/55"
);
...
<pre><code class="language-bash">curl -X PUT \
    "https://erptec.net/erp/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
<pre><code class="language-bash">curl -X DELETE \
    "https://erptec.net/erp/connector/api/sell/odio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
...
<pre><code class="language-bash">curl -X POST \
    "https://erptec.net/erp/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/list-sell-return"
);
...
<pre><code class="language-bash">curl -X POST \
    "https://erptec.net/erp/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/taxonomy?type=quia" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/taxonomy"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/taxonomy/1"
);
...
<pre><code class="language-bash">curl -X GET \
    -G "https://erptec.net/erp/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"</code></pre>
<pre><code class="language-javascript">const url = new URL(
    "https://erptec.net/erp/connector/api/user/loggedin"
);
