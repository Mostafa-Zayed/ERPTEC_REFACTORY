<?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			...
			<div class="box-footer bg-gray disabled text-center">
				...
				<?php else: ?>
					<?php if(isset($action_type) && $action_type == 'register'): ?>
						<a href="<?php echo e(route('register'), false); ?>?package=<?php echo e($package->id, false); ?>" 
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/Modules/Superadmin/Providers/../Resources/views/subscription/partials/packages.blade.php ENDPATH**/ ?>