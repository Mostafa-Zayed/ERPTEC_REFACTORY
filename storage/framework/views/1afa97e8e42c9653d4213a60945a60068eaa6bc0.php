			...
			<div class="pull-right text-white">
	        	<?php if(!($request->segment(1) == 'business' && $request->segment(2) == 'register')): ?>
		        	...
		        	<?php if(config('constants.allow_registration')): ?>
		            	<a 
		            		href="<?php echo e(route('register'), false); ?><?php if(!empty(request()->lang)): ?><?php echo e('?lang=' . request()->lang, false); ?> <?php endif; ?>"
...
</div><?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/resources/views/layouts/partials/header-auth.blade.php ENDPATH**/ ?>