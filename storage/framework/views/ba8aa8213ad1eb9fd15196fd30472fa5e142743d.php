...
<?php $__env->startSection('content'); ?>
    <div class="login-form col-md-12 col-xs-12 right-col-content" id="app">
        ...
        <form method="POST" action="<?php echo e(route('login'), false); ?>" id="login-form">
            ...
            <div class="form-group has-feedback <?php echo e($errors->has('username') ? ' has-error' : '', false); ?>">
                ...
                ?>
                <input id="username" type="text" class="form-control" name="username" value="<?php echo e($username, false); ?>" required autofocus placeholder="<?php echo app('translator')->getFromJson('lang_v1.username'); ?>" style="padding:0 10px;">
            ...
            <div class="form-group">
                ...
                <a href="<?php echo e(route('password.request'), false); ?>" class="pull-right" style="margin:0 10px;">
...
<?php echo $__env->make('layouts.auth2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/resources/views/auth/login.blade.php ENDPATH**/ ?>