...
<header class="header-area" id="header-area">
    <nav class="navbar navbar-expand-md fixed-top">
        <div class="container">
            <div class="site-logo">
                <a class="navbar-brand" href="{{route('welcome')}}"><img src="{{$__logo_url}}" class="img-fluid" change-src-onscroll="{{$__logo_url}}" alt="logo" loading="lazy"/></a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav" style="letter-spacing: 1px;">
                    ...
                    @if(app()->getLocale() == 'en')
                        <li class="nav-item">
                            <a class="hero-nav__link" href="{{route('welcome.lang','ar')}}">Arabic</a>
                        </li>    
                    @else
                        <li class="nav-item">
                            <a class="hero-nav__link" href="{{route('welcome.lang','en')}}">English</a>
                        </li>    
                    @endif
                </ul>
            </div>
...
{{--
    ...
    <section class="start_home demo1">
            <div class="banner_top">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 start-home-content">
                            <h1>
                        ...
                        <div class="col-md-7 start-home-img">
                            <img class="img-fluid" src="{{asset('public/website/images/banner-2.png')}}" alt="Img"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="shape-bottom">
                <img src="{{asset('public/website/images/shapes/shape-1.svg')}}" alt="shape" class="bottom-shape img-fluid">
            </div>
        </section>
    <!-- End Home Area -->
    ...
    <section id="AppFeatures" class="section-block features-style1"  data-scroll-index="1">
            ...
            <div class="container">
                <div class="section-header">
                    <h2>@lang('cms::lang.features')</h2>
                    <p style="letter-spacing: 1px;">@lang('cms::lang.features_description')</p>
                </div>
                <div class="row">
                    <!-- Start Features Item -->
                    <div class="col-md-4">
                        <div class="feature-block">
                            <span class="feature-icon icon-1">
                                <img src="{{asset('public/modules/cms/img/pos.png')}}">
                            </span>
                            <h3>Easy To Use</h3>
                            <p style="letter-spacing: 1px;">We provide marketing to businesses to looking for a partner digital media.</p>
                        </div>
                    </div>
                    <!-- End Features Item -->
                    ...
                    <div class="col-md-4">
                        <div class="feature-block">
                            <span class="feature-icon icon-2">
                                {{-- <i class="ti-gift"></i> --}}
                                <img src="{{asset('public/modules/cms/img/pos.gif')}}">
                            </span>
                            <h3>@lang('cms::lang.feature1_heading')</h3>
                            <p>@lang('cms::lang.feature1_content')</p>
                        </div>
                    </div>
                    <!-- End Features Item -->
                    ...
                    <div class="col-md-4">
                        <div class="feature-block">
                            <span class="feature-icon icon-3">
                                ...
                                <img src="{{asset('public/modules/cms/img/shop.png')}}">
                            </span>
                            <h3>@lang('cms::lang.feature2_heading')</h3>
                            <p>@lang('cms::lang.feature2_content')</p>
                        </div>
                    </div>
                    <!-- End Features Item -->
{{--
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="{{asset('public/website/images/step1.png')}}" /></div>
                                <h3>@lang('cms::lang.how_work_step1_title')</h3>
                                <p style="letter-spacing: 1px;">@lang('cms::lang.how_work_step1_content')</p>
                            </div>
                        </div>
                        <!-- End Block 1 -->
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="{{asset('public/website/images/step2.png')}}" /></div>
                        ...
                        <div class="description-block">
                            <div class="inner-box">
                                <div class="step_num"><img src="{{asset('public/website/images/step3.png')}}" /></div>
