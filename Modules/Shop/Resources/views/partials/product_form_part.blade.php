<div class="col-md-3">
	<div class="form-group">
      ...
      <br>
        <label>
        	<input type="hidden" name="shop_disable_sync" value="0">
          	{!! Form::checkbox('shop_disable_sync', 1, $is_disabled, ['class' => 'input-icheck']); !!} <strong>@lang('shop::lang.shop_disable_sync')</strong>
        </label>
