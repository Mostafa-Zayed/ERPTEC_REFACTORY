...
<html lang="<?php echo e(app()->getLocale(), false); ?>" dir="<?php echo e(in_array(session()->get('user.language', config('app.locale')), config('constants.langs_rtl')) ? 'rtl' : 'ltr', false); ?>">
    <head>
        ...
        <link rel="icon" href="<?php echo e(asset('public/website/images/logo_test.png'), false); ?>" type="image/gif" sizes="16x16">
    ...
    <body class="<?php if($pos_layout): ?> hold-transition lockscreen <?php else: ?> hold-transition skin-<?php echo e(get_business_theme_color(), false); ?> sidebar-mini <?php endif; ?>">
        <div class="wrapper thetop">
            ...
            <audio id="success-audio">
              <source src="<?php echo e(asset('/public/audio/success.ogg?v=' . $asset_v), false); ?>" type="audio/ogg">
              <source src="<?php echo e(asset('/public/audio/success.mp3?v=' . $asset_v), false); ?>" type="audio/mpeg">
            </audio>
            <audio id="error-audio">
              <source src="<?php echo e(asset('/public/audio/error.ogg?v=' . $asset_v), false); ?>" type="audio/ogg">
              <source src="<?php echo e(asset('/public/audio/error.mp3?v=' . $asset_v), false); ?>" type="audio/mpeg">
            </audio>
            <audio id="warning-audio">
              <source src="<?php echo e(asset('/public/audio/warning.ogg?v=' . $asset_v), false); ?>" type="audio/ogg">
              <source src="<?php echo e(asset('/public/audio/warning.mp3?v=' . $asset_v), false); ?>" type="audio/mpeg">
            </audio>
        </div>
...
</html><?php /**PATH /home/u521976387/domains/erptec.net/public_html/erp/resources/views/layouts/app.blade.php ENDPATH**/ ?>