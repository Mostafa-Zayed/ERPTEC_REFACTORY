...
class Category extends Model
{
    ...
    public function scopeOnlyChild(Builder $query, $categoryId = null): Builder
    {
    ...
    public function scopeType(Builder $query, $type = 'product'): Builder
    {
    ...
    {
        return $this->hasOne(ShopCategory::class,'category_id','id');
    }
    
    public function getBannerUrlAttribute()
    {
        if(isset($this->shopCategory->banner)){
            return asset('public/uploads/' . $this->shopCategory->banner);
        }
        return null;
    }
    ...
    {
        if(isset($this->shopCategory->icon)){
            return asset('public/uploads/' . $this->shopCategory->icon);
        }
        return null;
    }
}
