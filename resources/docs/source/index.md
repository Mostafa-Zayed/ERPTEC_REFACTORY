...
[Get Postman Collection](https://www.erptec.net/erp/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"nihil","ip_address":"aut","latitude":"est","longitude":"sequi"}'
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"voluptatibus","latitude":"voluptatem","longitude":"odit"}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/holidays?location_id=veritatis&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/holidays"
);

let params = {
    "location_id": "veritatis",
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=a&follow_up_type=qui&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"et","schedule_type":"animi","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=et&biz_name=quia&mobile_num=17&contact_id=veritatis&order_by=dolorem&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"quia","mobile_name":"quis","call_type":"call","start_time":"incidunt","end_time":"qui","duration":"harum"}]}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=molestias&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":4,"initial_amount":176.604,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":82.50185,"total_card_slips":8,"total_cheques":19,"closing_note":"aut","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/contactapi?type=quis&name=exercitationem&biz_name=sint&mobile_num=6&contact_id=sit&order_by=optio&direction=hic&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"velit","prefix":"accusantium","first_name":"est","middle_name":"sed","last_name":"aliquid","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"velit","address_line_2":"dolorum","city":"minus","state":"saepe","country":"et","zip_code":"voluptatem","customer_group_id":"aperiam","contact_id":"ducimus","dob":"2000-06-13","custom_field1":"laborum","custom_field2":"aut","custom_field3":"magnam","custom_field4":"eum","email":"rerum","shipping_address":"dolorem","position":"natus","opening_balance":0,"source_id":16,"life_stage_id":20,"assigned_to":[]}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"quia","prefix":"doloremque","first_name":"voluptatem","middle_name":"vel","last_name":"dignissimos","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"rem","address_line_2":"ab","city":"est","state":"modi","country":"eum","zip_code":"mollitia","customer_group_id":"debitis","contact_id":"voluptates","dob":"2000-06-13","custom_field1":"fugit","custom_field2":"omnis","custom_field3":"suscipit","custom_field4":"saepe","email":"minima","shipping_address":"quos","position":"aliquam","opening_balance":10.3,"source_id":11,"life_stage_id":8,"assigned_to":[]}'
...
let body = {
    ...
    "country": "eum",
    "zip_code": "mollitia",
    "customer_group_id": "debitis",
    "contact_id": "voluptates",
    "dob": "2000-06-13",
    "custom_field1": "fugit",
    "custom_field2": "omnis",
    "custom_field3": "suscipit",
    "custom_field4": "saepe",
    "email": "minima",
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":12,"card_number":"aut","card_holder_name":"totam","card_transaction_number":"aliquam","card_type":"numquam","card_month":"nam","card_year":"ut","card_security":"quasi","transaction_no_1":"quis","transaction_no_2":"ut","transaction_no_3":"nihil","cheque_number":"maxime","bank_account_number":"dolor","note":"similique"}'
...
let body = {
    ...
    "card_transaction_number": "aliquam",
    "card_type": "numquam",
    "card_month": "nam",
    "card_year": "ut",
    "card_security": "quasi",
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/expense?location_id=quo&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=temporibus&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":5,"final_total":2.3,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":11,"expense_for":1,"contact_id":16,"additional_notes":"enim","is_refund":0,"is_recurring":0,"recur_interval":12,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"maiores","recur_repetitions":1,"payment":[{"amount":453.13,"method":"cash","account_id":4,"card_number":"magnam","card_holder_name":"sunt","card_transaction_number":"incidunt","card_type":"sit","card_month":"quam","card_year":"architecto","card_security":"mollitia","transaction_no_1":"totam","transaction_no_2":"cum","transaction_no_3":"voluptatem","note":"non","cheque_number":"laborum"}]}'
    ...
    "payment": [
        {
            ...
            "card_transaction_number": "incidunt",
            "card_type": "sit",
            "card_month": "quam",
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://www.erptec.net/erp/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":19764693.1992,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":11,"expense_for":20,"contact_id":10,"additional_notes":"saepe","is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"sequi","recur_repetitions":6,"payment":[]}'
...
let body = {
    "final_total": 19764693.1992,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 11,
    "expense_for": 20,
    "contact_id": 10,
    "additional_notes": "saepe",
    "is_recurring": 0,
    "recur_interval": 20,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/expense-refund?location_id=aut&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=sed&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/product?order_by=est&order_direction=nemo&brand_id=corrupti&category_id=fuga&sub_category_id=aut&location_id=quis&selling_price_group=sit&name=quod&sku=facilis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/product"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/product/1?selling_price_group=voluptas" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/variation/2?product_id=a&location_id=ut&brand_id=maiores&category_id=enim&sub_category_id=et&not_for_selling=explicabo&name=veritatis&sku=incidunt&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/sell?location_id=necessitatibus&contact_id=aut&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=rerum&service_staff_id=deserunt&shipping_status=ordered&only_subscriptions=ea&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "rerum",
    "service_staff_id": "deserunt",
    "shipping_status": "ordered",
    "only_subscriptions": "ea",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":10,"contact_id":3,"transaction_date":"2020-07-22 15:48:29","invoice_no":"sit","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":6,"discount_amount":10,"discount_type":"fixed","sale_note":"ipsum","staff_note":"et","commission_agent":17,"shipping_details":"Express Delivery","shipping_address":"reiciendis","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":10,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"enim","recur_repetitions":16,"rp_redeemed":12,"rp_redeemed_amount":13.5,"types_of_service_id":10,"service_custom_field_1":"consequatur","service_custom_field_2":"eius","service_custom_field_3":"vitae","service_custom_field_4":"dolor","service_custom_field_5":"et","service_custom_field_6":"consequatur","round_off_amount":1376.65317745,"table_id":19,"service_staff_id":20,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":15,"note":"est"}],"payments":[{"amount":453.13,"method":"cash","account_id":19,"card_number":"expedita","card_holder_name":"quia","card_transaction_number":"doloremque","card_type":"commodi","card_month":"harum","card_year":"ex","card_security":"corporis","transaction_no_1":"quae","transaction_no_2":"consequuntur","transaction_no_3":"consequatur","bank_account_number":"ex","note":"odio","cheque_number":"esse"}]}]}'
            ...
            "payments": [
                {
                    ...
                    "method": "cash",
                    "account_id": 19,
                    "card_number": "expedita",
                    "card_holder_name": "quia",
                    "card_transaction_number": "doloremque",
                    "card_type": "commodi",
                    "card_month": "harum",
                    "card_year": "ex",
                    "card_security": "corporis",
                    "transaction_no_1": "quae",
                    "transaction_no_2": "consequuntur",
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://www.erptec.net/erp/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":8,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":9,"discount_amount":10,"discount_type":"fixed","sale_note":"sit","staff_note":"magnam","sells":[{"is_suspend":false}],"commission_agent":2,"shipping_details":"Express Delivery","shipping_address":"repudiandae","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":17,"pay_term_number":20,"pay_term_type":"months","is_recurring":0,"recur_interval":2,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"facilis","recur_repetitions":2,"rp_redeemed":6,"rp_redeemed_amount":13.5,"types_of_service_id":9,"service_custom_field_1":"maiores","service_custom_field_2":"ut","service_custom_field_3":"qui","service_custom_field_4":"culpa","service_custom_field_5":"alias","service_custom_field_6":"aut","round_off_amount":53680646.95905343,"table_id":20,"service_staff_id":6,"change_return":0,"change_return_id":19,"products":[{"sell_line_id":1,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":17,"discount_amount":0,"discount_type":"percentage","sub_unit_id":14,"note":"qui"}],"payments":[{"payment_id":10,"amount":453.13,"method":"cash","account_id":17,"card_number":"omnis","card_holder_name":"sint","card_transaction_number":"quia","card_type":"repellat","card_month":"dolores","card_year":"illum","card_security":"rerum","transaction_no_1":"molestiae","transaction_no_2":"velit","transaction_no_3":"culpa","note":"eaque","cheque_number":"deleniti","bank_account_number":"ratione"}]}'
...
let body = {
    ...
    "service_custom_field_4": "culpa",
    "service_custom_field_5": "alias",
    "service_custom_field_6": "aut",
    "round_off_amount": 53680646.95905343,
    "table_id": 20,
    "service_staff_id": 6,
    "change_return": 0,
    "change_return_id": 19,
    ...
    "payments": [
        {
            ...
            "transaction_no_3": "culpa",
            "note": "eaque",
            "cheque_number": "deleniti",
            "bank_account_number": "ratione"
        }
    ]
}
...
```bash
curl -X DELETE \
    "https://www.erptec.net/erp/connector/api/sell/nihil" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":20,"transaction_date":"2020-5-7 15:20:22","invoice_no":"magnam","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":12,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":9,"shipping_status":"ordered","delivered_to":"amet"}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/table?location_id=placeat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/taxonomy?type=repellat" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"repudiandae","first_name":"nihil","last_name":"laboriosam","email":"nesciunt","is_active":"velit","user_type":"dignissimos","crm_contact_id":10,"allow_login":false,"username":"sit","password":"in","role":12,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"occaecati","max_sales_discount_percent":"voluptas","selected_contacts":true,"selected_contact_ids":[],"dob":"soluta","gender":"itaque","marital_status":"eius","blood_group":"eos","contact_number":"ratione","alt_number":"optio","family_number":"quia","fb_link":"voluptatum","twitter_link":"est","social_media_1":"non","social_media_2":"quia","custom_field_1":"sint","custom_field_2":"quasi","custom_field_3":"quidem","custom_field_4":"a","guardian_name":"sed","id_proof_name":"voluptatem","id_proof_number":"ut","permanent_address":"fugit","current_address":"porro","bank_details":[{"account_holder_name":"sint","account_number":"nostrum","bank_name":"eius","bank_code":"iusto","branch":"quis","tax_payer_id":"repellendus"}]}'
...
let body = {
    ...
    "cmmsn_percent": "occaecati",
    "max_sales_discount_percent": "voluptas",
    ...
    "social_media_2": "quia",
    "custom_field_1": "sint",
    "custom_field_2": "quasi",
    "custom_field_3": "quidem",
    "custom_field_4": "a",
    "guardian_name": "sed",
    "id_proof_name": "voluptatem",
    "id_proof_number": "ut",
    "permanent_address": "fugit",
    "current_address": "porro",
    "bank_details": [
        {
            "account_holder_name": "sint",
            "account_number": "nostrum",
            "bank_name": "eius",
            "bank_code": "iusto",
            "branch": "quis",
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/user?service_staff=sit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"vel","new_password":"omnis"}'
...
```bash
curl -X POST \
    "https://www.erptec.net/erp/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"eaque"}'
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/profit-loss-report?location_id=eaque&start_date=2018-06-25&end_date=2018-06-25&user_id=hic" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://www.erptec.net/erp/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://www.erptec.net/erp/connector/api/notifications"
);
