...
"daily_pickup" => "الحد الأقصي لإختيار العملاء المحتملين يوميا في موديول علاقات العملاء    ",
"all_account_permission" => "كل اذن الحساب",
"access_accounts_permission" => "إذن الوصول إلى الحسابات",
...
"transaction_edit_days" => "تستطيع ان تتحكم في امكانية التعديل علي المبيعات من خلال عدد الايام التي تحددها هنا  .",
'sub_sku' => "Sku اختياري. <br> <br> <small> احتفظ به فارغًا لإنشاء sku تلقائيًا. <small>",
