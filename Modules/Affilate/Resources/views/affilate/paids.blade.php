@extends('layouts.app')
@section('title', __('affilate::lang.paids'))
...
<section class="content">
    ...
    <div class="default-box">
        <div class="default-box-head d-flex align-items-center justify-content-end">
            <button type="button" class="main-dark-btn btn-modal" data-href="{{action('\Modules\Affilate\Http\Controllers\AffilateController@createpaid')}}" 
            	...
            	<table class="main_light_table table table-bordered table-striped" id="sync_log_table">
            		<thead>
            			<tr>
            				...
            				<th>@lang( 'affilate::lang.amount' )</th>
            				<th>@lang( 'affilate::lang.added_by' )</th>
...
<script type="text/javascript">
    $(document).ready( function () {
        ...
        var sync_log_table =  $('#sync_log_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{action('\Modules\Affilate\Http\Controllers\AffilateController@viewpaids')}}",
            "order": [[ 1, "desc" ]],
            columnDefs: [ {
                "targets": 4,
                "orderable": false
            ...
            columns: [
                ...
                {data: 'affilator', name: 'users.first_name'},
