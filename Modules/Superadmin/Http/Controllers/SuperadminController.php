...
use Modules\Superadmin\Interfaces\SuperadminInterface;
...
class SuperadminController extends BaseController
{
    ...
    public function index()
    {
        ...
        if(BusinessService::businessCan(['superadmin'])) {
        ...
        return view('superadmin::superadmin.index',
            [
                'date_filters' => Util::generateDateFillter(),
                'not_subscribed' => $not_subscribed,
                'monthly_sells_chart' => $monthly_sells_chart
            ]);
        }
    ...
    {
        return view('superadmin::shipment.index');
    }
}
